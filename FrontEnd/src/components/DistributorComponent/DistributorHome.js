        ...
        <div className="dashboard-container">
            <div className="sidebar">
                ...
                <ul className="nav-links">
                    <li className={`nav-link ${board === 'Product' ? 'active' : ''}`} onClick={() => handleItemClick('Product')} style={{height:'40px'}}>Products</li>
                    <li className={`nav-link ${board === 'AddProduct' ? 'active' : ''}`} onClick={() => handleItemClick('AddProduct')} style={{height:'40px'}}>Add Product</li>
